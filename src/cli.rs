pub mod cli {
    ...
    pub enum Commandd {
        ...
        Peek {
            #[arg(
                short = 'o',
                help = "the path or name of the file",
                required = true,
        ...
        Burn {
            #[arg(
                short = 't',
                help = "the name or the path of the file you want to delete",
                value_name = "File/Path",
                required = true
            )]
            file: String,
        ...
        Rn {
            #[arg(
                short = 'f',
                help = "add the file you want to rename",
                required = true,
                value_name = "File/Path"
            )]
            from: String,
            #[arg(
                short = 't',
                help = "the new name you want to give to the file",
        ...
        Clone {
            #[arg(
                long = "target",
                help = "the targeted file you want to clone",
                required = true,
                value_name = "File/Path"
            )]
            target: String,
            #[arg(
                long = "output",
                help = "the output name of the cloned file or the name of existed one",
                default_value = "output",
                value_name = "New Name/existed file"
            )]
            outputname: String,
        },
        ...
        Forge {
            #[arg(
                long = "make",
                short = 'm',
                help = "the name of the file you want to make",
                required = true,
                value_name = "Name+format"
            )]
            name: String,
        },
        ...
        Calc {
            #[arg(
                long = "",
                help = "put the math problem you want to solve",
                required = true,
                value_name = "Math"
            )]
            math: String,
        ...
        Mv {
            #[arg(
                short = 'f',
                help = "the name or the path you want to move",
                required = true,
                value_name = "File/Path"
            )]
            from: String,
            #[arg(
                short = 't',
                help = "the path of the new place you want to put it in",
                required = true,
                value_name = "Path"
            )]
            to: String,
        ...
        Tar {
            #[arg(
                short = 'f',
                help = "the operation you want to run",
                value_name = "load/Unload",
                required = true
            )]
            flag: String,
            #[arg(
                short = 's',
                help = "the name or the path of the file that you want to run the operation on",
                required = true
            )]
            the_name: String,
            #[arg(
        ...
        Transmute {
            #[arg(
                short = 't',
                help = "the type of encoding/decodeing you want to use",
                required = true,
                value_name = "Type"
            )]
            ttype: String,
            ...
            #[arg(
                short = 's',
                help = "the file name or path that you want to encode or decode",
                value_name = "File",
                required = true
            )]
            fname: String,
        ...
        Mk {
            #[arg(
                required = true,
                help = "put the name of the directory you want to make",
                value_name = "Name"
            )]
            name: String,
        },
        ...
        Stop {
            #[arg(
                long = "pid",
                required = true,
                help = "add the pid number of the process you want to shutdown",
                value_name = "pid"
            )]
            pid: i32,
        },
        ...
        Zip {
            #[arg(
                short = 'o',
                required = true,
                help = "the operation you want to make <Zip-New: to make a new zip archive/Zip-All: to comparse any directory or files into archive/extract: to extract zip archives>",
                value_name = "Zip-New/Zip-All/extract"
            )]
            op: String,
            ...
            #[arg(
                long = "name",
                value_name = "File/Name",
                help = "the name of the new file you are making",
                default_value = ""
            )]
            file_name: String,
            #[arg(
                long = "f1",
                value_name = "File/Name",
                help = "to add or make a new file inside the new archive you are making",
                default_value = ""
            )]
            f1: String,
            #[arg(
            ...
            #[arg(
                short = 's',
                value_name = "File/Path/Dir",
                help = "the dir you want to run opraion on",
                default_value = ""
            )]
            src_dir: String,
            #[arg(
                short = 'r',
                value_name = "Name",
                help = "the name of the new file you after extracion or compressing",
                default_value = ""
            )]
            res_dir: String,
        },
        ...
        Tree {
            #[arg(
                ...
                value_name = "Path",
                default_value = ".",
                help = "the path of the directory you want to list"
            )]
            path: String,
        },
        ...
        Hostname {
            ...
            flag: String,
            #[arg(
                help = "use it to add edit the host name",
                value_name = "Name",
                required = false,
                default_value = ""
            )]
        ...
        Configer {
            ...
            operation: String,
            #[arg(
                help = "the username you want to make the operation on",
                short = 'u',
                required = false,
                group = "user",
                default_value = ""
